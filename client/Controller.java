...
public class Controller implements Initializable {
    ...
    @FXML
    PasswordField regLoginField;

    @FXML
    PasswordField regNickField;

    @FXML
    HBox authPanel,regPanel, msgPanel;
    ...
    public void sendReg() {
        NetworkService.sendReg(regLoginField.getText(), regPassField.getText(), regNickField.getText());
        regLoginField.clear();
        regPassField.clear();
        regNickField.clear();
    }
